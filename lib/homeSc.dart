 ...
 for (var purchaseDetails in purchases) {
   if (purchaseDetails.status == PurchaseStatus.purchased ||
     ...
     if (Platform.isIOS) {
       ...
       final receiptData = await addition.appStoreReceipt;


       if (receiptData != null) {
         // 🔗 Send receiptData to your backend and validate with Apple
         expiryDate = await MyBackend.validateAndGetExpiry(receiptData);
       }
     } else {
       // Android fallback (still manual calculation for now)
